    ...
    <div className="flex flex-col gap-4 my-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4 mt-10">
        {testimonials?.map((testimonial, index) => (
            <div className="rounded-medium bg-content1 p-5 shadow-small" key={index}>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                {Array.from({ length: 5 }, (_, i) => (
                  <Icon
                    key={i}
                    className={i + 1 <= testimonial?.rating ? "text-warning" : "text-default-500"}
            ...
            <div className="mt-4 w-full">
              <p className="font-medium text-default-900">{testimonial.title}</p>
